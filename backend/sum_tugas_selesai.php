...
// Query untuk menghitung jumlah tugas yang selesai
$statement = $database_connection->prepare("SELECT COUNT(*) AS `jumlah_tugas_selesai` FROM `tasks` WHERE `status` = 'selesai' AND `user_id` = ?;");
